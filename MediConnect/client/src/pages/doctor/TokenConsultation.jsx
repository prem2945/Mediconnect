...
function TokenConsultation() {
    ...
    const handleSubmit = async (e) => {
        ...
        setSaving(true);
        try {
            await completeTokenConsultation(tokenId, formData);
            setToast({ type: 'success', message: 'Consultation completed successfully' });
            setTimeout(() => navigate('/doctor/token-queue'), 1500);
        } catch (err) {
            setToast({
                type: 'error',
    ...
    const pastTokens = data?.pastTokens || [];
            ...
            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm transition-all duration-300">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center shadow-sm">
                            <div className="text-center">
                                <p className="text-[8px] text-emerald-200 font-medium leading-none">
                                    TKN
                                </p>
                        ...
                        <div>
                            ...
                            <p className="text-gray-500 text-sm mt-0.5">
                                Currently Serving · Token #{token?.tokenNumber}
                                {token?.clinic && (
                    ...
                    >
                        ...
                        />
                        {isCompleted ? 'Completed' : 'Being Served'}
                    </span>
                </div>
            </div>
                                    ...
                                    <div key={past._id} className="px-6 py-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-2 text-sm">
                                                ...
                                                <Hash className="w-3.5 h-3.5 text-gray-400 ml-1" />
                                                <span className="text-gray-500">
                                                    Token {past.tokenNumber}
                                                </span>
                                            </div>
...
export default TokenConsultation;
